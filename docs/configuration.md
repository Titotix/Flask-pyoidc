...
As mentionned in OpenID specification, `userinfo_endpoint` is optionnal. If it's
not provided, no userinfo request will be done. `flask_pyoidc.UserSession.userinfo` will be set to `None`.  
